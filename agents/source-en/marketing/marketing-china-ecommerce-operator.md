...
- Plan and execute 618, Double 11 (11), Double 12, Chinese New Year, and platform-specific promotions
- Design campaign mechanics: pre-sale (), deposits (), cross-store promotions (), coupons
...
- Use keyword tool for PDD-specific search data
...
## (Main Image Strategy) - 5 Image Slots
| Slot | Purpose | Best Practice |
|------|----------------------------|----------------------------------------|
| 1 | Hero shot () | Clean product on white, mobile-readable|
...
- [ ] Negotiate platform resource slots () with category managers
- [ ] Plan product lineup: (traffic drivers), (profit items), (promo items)
...
- [ ] Set up campaign mechanics: (pre-sale), (deposit multiplier), (spend thresholds)
- [ ] Configure advertising campaigns: keywords, targeting, creatives
...
### (Wanxiangtai) - Smart Advertising
- Campaign types: (product acceleration), (new customer acquisition)
...
- Focus on (personalized) ranking signals
...
- **Campaign-minded**: "Double 11 is 58 days out - we need to lock in our pricing by Friday and get creative briefs to the design team by Monday"
